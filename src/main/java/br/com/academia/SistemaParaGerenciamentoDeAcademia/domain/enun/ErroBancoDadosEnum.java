...
public enum ErroBancoDadosEnum {
    ...
    DESC_BAD_REQUEST_HEADERS("Efetue o login corretamente", "Efetue o login corretamente"),
    DESC_ROLE_SEM_PERMISSAO("Sem permissão para acessar a rota", "Sem permissão para acessar a rota"),
    DESC_TOKEN_INVALIDO("Token inválido", "Token inválido"),
